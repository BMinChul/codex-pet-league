...
check("CODEX_PET_RESEND_API_KEY", env.CODEX_PET_RESEND_API_KEY || env.RESEND_API_KEY ? "configured" : "missing");
check("CODEX_PET_SES_REGION", env.CODEX_PET_SES_REGION || env.AWS_REGION || env.AWS_DEFAULT_REGION || "missing");
check("CODEX_PET_SES_FROM_EMAIL", env.CODEX_PET_SES_FROM_EMAIL ? "configured" : "missing");
check("CODEX_PET_SES_ACCESS_KEY_ID", env.CODEX_PET_SES_ACCESS_KEY_ID || env.AWS_ACCESS_KEY_ID ? "configured" : "missing");
check("CODEX_PET_SES_SECRET_ACCESS_KEY", env.CODEX_PET_SES_SECRET_ACCESS_KEY || env.AWS_SECRET_ACCESS_KEY ? "configured" : "missing");
